...
t=-7:1:7;                                %defining the x axis how many point take value.
...
plot(t,x1);                              %plots the data sequence Y at the values specified in X.
...
plot(t,x2);                                 %plots the data sequence Y at the values specified in X.
xlabel('Time');                             %x-axis label.
ylabel('Amplitude');                        %y-axis label.
...
t1=-14:2:14;                                %defining the x axis how many point take value.
...
plot(t1,x3);                                %plots the data sequence Y at the values specified in X.
xlabel('Time');                             %x-axis label.
ylabel('Amplitude');                        %y-axis label.
title('Expanded Signal x(t/2)');            %title  Graph title.
axis([-15 15 0 8]);                         %AXIS([XMIN XMAX YMIN YMAX]) sets scaling for the x- and y-axes on the current plot.